  ...
  const features = [
    {
      ...
      description:
        "AI-powered spoiler detection across all major social platforms and news sites.",
    ...
    },
    {
      ...
      description:
        "Choose exactly what you want to see with one-click spoiler reveals.",
    ...
    },
    {
      ...
      description:
        "Instant protection as you scroll with advanced content analysis.",
    ...
    },
    {
      ...
      description:
        "Works on Reddit, Twitter/X, Facebook, YouTube, Instagram, and more.",
    ...
    },
    {
      ...
      description:
        "Join thousands of users browsing spoiler-free across the web.",
  ...
  const testimonials = [
    {
      ...
      content:
        "Finally! I can browse Reddit without having season finales ruined. Spoiler Shield is a game-changer.",
      rating: 5,
      avatar: "SC",
    ...
    },
    {
      ...
      role: "Formula 1 Fan",
      content:
        "As someone who watches races on delay, this extension has saved my weekends. No more accidental spoilers!",
      rating: 5,
      avatar: "MR",
    ...
    },
    {
      ...
      role: "Movie Buff",
      content:
        "The Marvel protection alone makes this worth it. I can finally use social media on opening weekend.",
      rating: 5,
      avatar: "EW",
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-x-hidden">
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
                Never get spoiled again. Our AI shields you from unwanted plot
                reveals across
                <span className="text-violet-400 font-semibold">
                  {" "}
                  Reddit, Twitter, Facebook
                </span>
                , and more. Add your watchlist and browse with confidence.
              </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
                {stats.map((stat, index) => (
                  <div
                    key={index}
                    className="group text-center p-6 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-violet-500/30 hover:bg-white/10 transition-all duration-500 hover:scale-105"
                  >
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-20">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Advanced AI technology meets beautiful design to keep your
                browsing experience completely spoiler-free
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                <div
                  key={index}
                  className="group relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 hover:border-white/20 hover:bg-white/10 transition-all duration-500 hover:scale-105 overflow-hidden"
                >
                  <div
                  ...
                  <div className="relative z-10">
                    <div
                      className={`text-white mb-6 p-3 rounded-2xl bg-gradient-to-r ${feature.color} w-fit group-hover:scale-110 transition-transform duration-300`}
                    >
                      {feature.icon}
                    </div>
        ...
        <section
          id="how-it-works"
          className="py-32 px-6 lg:px-8 bg-white/5 backdrop-blur-sm"
        >
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-20">
              <h2 className="text-5xl md:text-6xl font-black text-white mb-8">
            ...
            <div className="grid md:grid-cols-3 gap-12 relative">
              ...
              <div className="text-center group">
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  One-click installation from Chrome Web Store or Firefox
                  Add-ons. Takes literally 3 seconds.
                </p>
              </div>
              ...
              <div className="text-center group md:mt-12">
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  Tell us what shows, movies, or sports you want to protect.
                  Simple as that.
                </p>
              </div>
              ...
              <div className="text-center group md:mt-24">
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  Enjoy completely spoiler-free browsing with automatic content
                  protection.
                </p>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {testimonials.map((testimonial, index) => (
                <div
                  key={index}
                  className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 hover:border-white/20 hover:bg-white/10 transition-all duration-500 hover:scale-105 relative overflow-hidden"
                >
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${testimonial.bgColor} opacity-0 group-hover:opacity-5 transition-all duration-500`}
                  ></div>
                  <div className="relative z-10">
                    <div className="flex items-center mb-6">
                      <div
                        className={`w-12 h-12 rounded-2xl bg-gradient-to-r ${testimonial.bgColor} flex items-center justify-center text-white font-bold mr-4`}
                      >
                        {testimonial.avatar}
                      </div>
                      <div>
        ...
        <section className="py-32 px-6 lg:px-8 bg-gradient-to-r from-violet-500/10 via-purple-500/10 to-fuchsia-500/10 backdrop-blur-sm">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-12 leading-relaxed">
              Join 50,000+ users who browse the web spoiler-free every single
              day
            </p>
